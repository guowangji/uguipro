...
public class DraggableObjectPrediction1 : MonoBehaviour, IDragHandler, IPointerDownHandler, IPointerUpHandler
{
    //原来的位置
    Vector2 myPivot;
    Vector3 myPos;
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        if (!notDragOut)
        {
            ...
            if(DraggableObjectScene1.predictionSave)
            DraggableObjectScene1.predictionSave.SetActive(true);
        }
