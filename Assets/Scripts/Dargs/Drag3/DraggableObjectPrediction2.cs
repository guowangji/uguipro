...
public class DraggableObjectPrediction2 : MonoBehaviour, IDragHandler, IPointerDownHandler, IPointerUpHandler
{
    //原来的位置
    Vector2 myPivot;
    Vector3 myPos;
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        if (!notDragOut)
        {
            ...
            GetComponentInChildren<Text>().text = "Dimentionality Reduction";
            GetComponentInChildren<Text>().color = new Color(143 / 255f, 143 / 255f, 143 / 255f, 255 / 255f);
            if (DraggableObjectScene2.predictionSave)
            DraggableObjectScene2.predictionSave.SetActive(true);
            DraggableObjectScene2.predictionSave = null;
        }
